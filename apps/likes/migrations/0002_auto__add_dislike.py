...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'likes_dislike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('post', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['posts.Post'])),
        ))
        db.send_create_signal(u'likes', ['Dislike'])

        # Adding M2M table for field user on 'Dislike'
        m2m_table_name = db.shorten_name(u'likes_dislike_user')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('dislike', models.ForeignKey(orm[u'likes.dislike'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['dislike_id', 'user_id'])


    def backwards(self, orm):
        # Deleting model 'Dislike'
        db.delete_table(u'likes_dislike')

        # Removing M2M table for field user on 'Dislike'
        db.delete_table(db.shorten_name(u'likes_dislike_user'))
