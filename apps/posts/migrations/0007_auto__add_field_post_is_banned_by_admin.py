...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.is_banned_by_admin'
        db.add_column(u'posts_post', 'is_banned_by_admin',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.is_banned_by_admin'
        db.delete_column(u'posts_post', 'is_banned_by_admin')
