...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Post.count_of_likes'
        db.add_column(u'posts_post', 'count_of_likes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Post.count_of_dislikes'
        db.add_column(u'posts_post', 'count_of_dislikes',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Post.count_of_likes'
        db.delete_column(u'posts_post', 'count_of_likes')

        # Deleting field 'Post.count_of_dislikes'
        db.delete_column(u'posts_post', 'count_of_dislikes')
